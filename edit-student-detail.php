      ...
      <?php include 'sidebar.php';?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
            <?php
            if(isset($_GET['studentid']) && ($_GET['sectionid']) && $_GET['courseid'] ){
                $stdid=$_GET['studentid'];
                $secid=$_GET['sectionid'];
                $couid=$_GET['courseid'];

            }
            $sql="select * from student left join course on student.course_id=course.course_id left join section on student.section_id=section.section_id where student_id=$stdid"; 
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="fname" value="<?php echo $row['fname'] ?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputName1">Student Last Name </label>
                        <input type="text" name="lname" value="<?php echo $row['lname'] ?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="date" name="age" value="<?php echo $row['age'] ?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <?php
                            ...
                            ?>
                                <option <?php echo $selected ?> value="<?php echo $row['section_id'] ?>"> <?php echo $row['sname'] ?></option>
                            <?php
                            }
